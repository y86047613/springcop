...
<html lang="zh-cn">
	...
	<body class="login-layout light-login">
										...
										<div class="widget-main">
											...
											<form id="validationRegisterForm" method="post" action="#">
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="parent" name="parent" type="text" class="form-control" placeholder="推荐码" />
															<i class="ace-icon fa fa-user"></i>
														</span>
													</label>
		...
		<script type="text/javascript" src="${contextPath}/static/assets/js/custom/twologin.js"></script>
